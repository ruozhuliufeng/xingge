package tech.msop.core.oss.template;
...
import tech.msop.core.oss.enums.PolicyType;
import tech.msop.core.oss.model.OssFile;
import tech.msop.core.oss.model.XingGeFile;
...
public class MinioTemplate implements OssTemplate {
	...
	public String fileLink(String fileName) {
		return ossProperties.getEndpoint().concat(StringConstant.SLASH).concat(getBucketName()).concat(StringConstant.SLASH).concat(fileName);
	}

	@Override
	@SneakyThrows
	public String fileLink(String bucketName, String fileName) {
		return ossProperties.getEndpoint().concat(StringConstant.SLASH).concat(getBucketName(bucketName)).concat(StringConstant.SLASH).concat(fileName);
	}

	@Override
	@SneakyThrows
	public XingGeFile putFile(MultipartFile file) {
		return putFile(ossProperties.getBucketName(), file.getOriginalFilename(), file);
	}

	@Override
	@SneakyThrows
	public XingGeFile putFile(String fileName, MultipartFile file) {
		return putFile(ossProperties.getBucketName(), fileName, file);
	}

	@Override
	@SneakyThrows
	public XingGeFile putFile(String bucketName, String fileName, MultipartFile file) {
		return putFile(bucketName, file.getOriginalFilename(), file.getInputStream());
	}

	@Override
	@SneakyThrows
	public XingGeFile putFile(String fileName, InputStream stream) {
		return putFile(ossProperties.getBucketName(), fileName, stream);
	}

	@Override
	@SneakyThrows
	public XingGeFile putFile(String bucketName, String fileName, InputStream stream) {
		return putFile(bucketName, fileName, stream, "application/octet-stream");
	}

	@SneakyThrows
	public XingGeFile putFile(String bucketName, String fileName, InputStream stream, String contentType) {
        ...
        XingGeFile file = new XingGeFile();
	...
	public String getOssHost(String bucketName) {
		return ossProperties.getEndpoint() + StringConstant.SLASH + getBucketName(bucketName);
	}
