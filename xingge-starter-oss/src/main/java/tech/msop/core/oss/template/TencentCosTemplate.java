...
public class TencentCosTemplate implements OssTemplate {
	...
	public String filePath(String bucketName, String fileName) {
		return getOssHost(bucketName).concat(StringConstant.SLASH).concat(fileName);
	}
	...
	@SneakyThrows
	public XingGeFile put(String bucketName, InputStream stream, String key, boolean cover) {
	...
	private String getBucketName(String bucketName) {
		return ossRule.bucketName(bucketName).concat(StringConstant.DASH).concat(ossProperties.getAppId());
	}
