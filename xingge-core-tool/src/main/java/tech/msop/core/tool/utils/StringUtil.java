...
import tech.msop.core.tool.support.StrSpliter;
...
public class StringUtil extends StringUtils {
	...
	public static String randomUUID() {
		...
		return new UUID(random.nextLong(), random.nextLong()).toString().replace(StringConstant.DASH, StringConstant.EMPTY);
	}
	...
	public static String escapeHtml(String html) {
		return StringUtil.isBlank(html) ? StringConstant.EMPTY : HtmlUtils.htmlEscape(html);
	}
